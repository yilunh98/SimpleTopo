...
class SimpleTopo(Topo):
	def __init__(self, **opts):
		...
		# h0 = self.addHost('h0', mac='20:00:00:00:00:01')
		# h1 = self.addHost('h1', mac='20:00:00:00:00:02')
		# h2 = self.addHost('h2', mac='20:00:00:00:00:03')
		# self.addLink(s0, h0, bw=10, delay='30ms')
		# self.addLink(s0, h1)
		# self.addLink(s0, h2)
